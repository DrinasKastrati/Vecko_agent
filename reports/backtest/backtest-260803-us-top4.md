...
**Datum:** 2026-08-03 | **Marknad/universum:** `us` (config/backtest_universe_us.txt) | **Universum:** 30 symboler | **Positioner:** 4 à 25 % | **Benchmark (^GSPC) köp-och-behåll:** +70.72 % | **Transaktionskostnad:** 0.75 % per affär (netto)
...
**Kravet för att få ändra en prompt: slå benchmark i BÅDA halvorna.** Halva 1 (2021-08-02 → 2024-01-30) benchmark +12.26 %, halva 2 (2024-01-30 → 2026-07-31) benchmark +52.08 %.

| Kombination | Hela perioden | Halva 1 | Halva 2 | Slår bench i båda? | Investerad | Max DD (hela) |
|---|---|---|---|---|---|---|
| Basfall (som böckerna körs i dag) | +42.13 % | +7.54 % | +20.96 % | nej | 84 % | −29.3 % |
| + lookback 120d | +53.23 % | +37.00 % | +21.68 % | nej (bara en halva) | 80 % | −29.4 % |
| + lookback 120d, skip 20d | +69.07 % | +27.27 % | +12.80 % | nej (bara en halva) | 81 % | −27.1 % |
| + 120d/skip20 + regim MA100 | +56.88 % | +31.74 % | +11.34 % | nej (bara en halva) | 63 % | −25.0 % |
| + 120d/skip20 + regim MA200 | +78.08 % | +39.89 % | +8.09 % | nej (bara en halva) | 65 % | −28.8 % |
| + 120d/skip20 + MA100 + horisont 60d | +47.21 % | +24.84 % | +6.24 % | nej (bara en halva) | 66 % | −25.0 % |
| Bara regim MA200 (annars basfall) | +70.15 % | +18.17 % | +34.55 % | nej (bara en halva) | 69 % | −23.6 % |
