...
|---|---|---|---|---|---|---|---|
| – | – | – | – | – | – | – | Inga öppnade positioner – 100 % kassa, se pending nedan |

### Pending veckorotation v29 (beslutad i veckorapport-260713.md – ej öppnad; körning skedde efter måndagens stängning)
| Aktie | Yahoo-ticker | Börs | Planerad entry (villkor) | Planerad stop-loss | Planerad målkurs | R/R | Status |
|---|---|---|---|---|---|---|---|
| Alleima | ALLEI.ST | Nasdaq Stockholm | Köp vid nästa öppning om kurs ≤ 97,80 kr (ref. 97,30 kr, prices.json 13/7 15:29 UTC) | 94,30 kr | 103,50 kr | ~1:2,05 | Primärcase v29 – binär Q2-risk fre 17/7 |
